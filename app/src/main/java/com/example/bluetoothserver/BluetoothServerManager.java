...
public class BluetoothServerManager extends Thread {
    ...
    public BluetoothServerManager(BluetoothAdapter _bluetoothAdapter, Handler
            _handlerNetworkExecutorResult) {
        ...
        try {
            ...
            //TODO Toast
            //Toast.makeText(getApplicationContext(), "Error: Bluetooth connection " + e, Toast.LENGTH_SHORT).show();
    ...
    public void run() {
        ...
        while (true) { //Poner una variable dispose para liberar memoria
            try {
